  ...
  <div class="Settings">
    <form>
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="fullname" v-model="allSettings.fullname" >
        {{allSettings.fullname}}
      </div>
      <div class="mb-3">
        <label for="location" class="form-label">Location</label>
        <input type="text" class="form-control" id="location" v-model="allSettings.location">
        {{allSettings.location}}
      </div>
      <div class="question_form mb-3"> 
            <label for="bio" class="form-label">Bio</label> 
             <textarea class="form-control" aria-label="With textarea" rows="3" id="bio" v-model="allSettings.bio" ></textarea>
             {{allSettings.bio}}
         </div>
         <div class="mb-3">
          <label for="username" class="form-label">Username</label>
          <input type="text" class="form-control" id="username" :value="allSettings.username" disabled>
        </div>
        <div class="mb-3">
            <div class="form-group">
            <label >Birth Date</label> <br>
                <el-date-picker v-model="allSettings.birthdate" type="date" placeholder="Pick a date"> </el-date-picker>
        ...
        <div class="changeprofile paddingwithborder">
          ...
          <input type="file" @change="onprofileselected" style="display:none"  ref="fileinput" >
        ...
        <div class="changecover paddingwithborder">
          ...
          <input type="file" @change="oncoverselected" style="display:none"  ref="fileinput1" >
          <span @click="$refs.fileinput1.click()">Upload your background</span>
        </div>
